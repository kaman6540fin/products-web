<template>
  <div class="header">
    ...
    <div class="bulletin-wrapper">
      ...
      <!-- v-if="poiInfo.discounts2" 是為了先判斷有值才顯示出來，不然在值還沒傳進來時就先調用，會報錯 -->
    ...
    <transition name="bulletin-detail">
      <div class="bulletin-detail" v-show="isShow">
        <div class="detail-wrapper">
          <div class="main-wrapper" :style="detailBg">
            <div class="icon" :style="headBg"></div>
    ...
    <div class="bg-wrapper" :style="contentBg">
