      ...
      <div class="food-wrapper">
        <div class="food-content">
          <div class="img-wrapper">
            ...
            <img src="./more.png" class="share-bt" />
            <img src="./share.png" class="more-bt" />
          </div>
        ...
        <div class="rating-wrapper" v-if="food.rating">
          <!-- 先用v-if確認 food.rating 有值再顯示,不然會有錯誤-->
...
export default {
  ...
  methods: {
    ...
    showView() {
      ...
      //在數據渲染到dom之後，再進行操作
      this.$nextTick(() => {
        // 若this.foodViewScroll存在，就create一個this.foodViewScroll的BsScroll實例
        if (!this.foodViewScroll) {
          this.foodViewScroll = new BScroll(this.$refs.foodView, {
            click: true
          });
        } else {
          //若this.foodViewScroll已經存在了，表示數據已經渲染過了，就讓this.foodViewScroll更新
          this.foodViewScroll.refresh();
        }
      });
    },
    closeView() {
